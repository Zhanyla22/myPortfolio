...
?>
          <li><a class="nav-link" href="admin/login.php">Войти</a></li>
        </ul>
...
?>
        ...
        <div class="col-lg-6">
        <h3 class="resume-title">учеба</h3>
          <?php
          $query4 = "SELECT * FROM resume";
          $run4 = mysqli_query($db,$query4);
          ;
  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <form action="forms/contact.php" method="post" role="form" class="php-email-form mt-4">
        ...
        <div class="form-group mt-3">
          <textarea class="form-control" name="text" rows="5" placeholder="Сообщение" required></textarea>
        </div>
        <div class="my-3">
          <div class="loading">Загрузка</div>
          <div class="error-message"></div>
          <div class="sent-message">Сообшение отправлено. Спасибо!</div>
        </div>
  ...
  <div class="credits">
    ...
    Сделала<a href="https://bootstrapmade.com/">Мамытова Жанылай</a>
  </div>
